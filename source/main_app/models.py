...
class Task(models.Model):
    description = models.CharField(max_length=100, null=False, blank=False, verbose_name='Задача')
    ...
    details = models.TextField(max_length=1500, null=False, blank=True, verbose_name='Детали задачи')
